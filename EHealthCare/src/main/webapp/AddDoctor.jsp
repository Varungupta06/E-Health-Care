...
<nav class="navbar navbar-expand-lg navbar-dark primary-background">
 ...
 <form action="AddDoctor" id ="addDoctor" method="POST">
    ...
    <div class="row">
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-2 ">
                    ...
                    <div class="col-md-6"><label class="labels" >Name</label><input name="name" required type="text" class="form-control" id="name"  placeholder="Enter name"></div>
                ...
                <div class="row mt-3">
                    <div class="col-md-12"><label class="labels" >Mobile Number</label><input name ="mobile" type="text" class="form-control" placeholder="enter phone number" value=""></div>
                    ...
                    <div class="col-md-12"><label class="labels">Education</label><input name="edu" type="text" class="form-control" placeholder="education" value=""></div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-6"><label class="labels">Country</label><input name="country" type="text" class="form-control" placeholder="country" value=""></div>
                    <div class="col-md-6"><label class="labels">State/Region</label><input name="state" type="text" class="form-control" value="" placeholder="state"></div>
                </div>
        ...
        <div class="col-md-4">
            <div class="p-3 py-5">
                ...
                <div class="col-md-12"><label class="labels">Experience </label><input name="exp" type="text" class="form-control" placeholder="experience" value=""></div> <br>
                <div class="col-md-12"><label class="labels">Specialist</label><input name="spec" type="text" class="form-control" placeholder="Specialist Details" value=""></div>
            </div>
        </div>
    </div>
</div>
