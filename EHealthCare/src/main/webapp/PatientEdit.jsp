...
<% 
		  for(Patient pp : patient){
			  %>
 <form action="PatientEdit" id ="editPatient" method="POST">
    ...
    <div class="row">
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-2 ">
                 ...
                 <div class="col-md-12"><label class="labels" >Patient ID:</label>
                    <input name="pid" required type="text" class="form-control" id="pid"  placeholder="<%=pp.getPid()%>"></div>
                   
               
               
                    <div class="col-md-12"><label class="labels" >Full Name</label>
                    <input name="name" required type="text" class="form-control" id="name"  placeholder="<%=pp.getName()%>"></div>
                   
               
                </div>
                <div class="row mt-3">
                    <div class="col-md-12"><label class="labels" >Mobile Number</label>
                    <input name ="mobile" type="text" class="form-control" placeholder="<%=pp.getMobile()%>" value=""></div>
                    
                    <div class="col-md-12"><label class="labels">Email ID</label>
                    <input name ="email" type="text" class="form-control" placeholder="<%=pp.getEmail()%>" value=""></div>
        ...
        <div class="col-md-4">
            <div class="p-3 py-5">
              ...
              <input name="issue" type="text" class="form-control" placeholder="<%=pp.getIssue()%>" value=""></div>
               <div class="col-md-12"><label class="labels">Address</label>
               <input name="address" type="text" class="form-control" placeholder="<%=pp.getAddress()%>" value=""></div>
            </div>
        </div>
    </div>
</div>
