...
<nav class="navbar navbar-expand-lg navbar-dark primary-background">
 ...
 <form action="BookAppointment" id ="book" method="POST">
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="col-md-12"><label class="labels" >Patient ID</label>
                    <input name="pid" required type="number" class="form-control" id="pid"  placeholder="Enter Patient ID:"></div>
               ...
               <div class="col-md-12"><label class="labels" >Doctor  ID</label>
                    <input name="did" required type="number" class="form-control" id="did"  placeholder="Enter Doctor ID:"></div>
                </div>
                <div class="row mt-3">
        ...
        <div class="col-md-4">
            <div class="p-3 py-5">
              ...
              <input name="issue" type="text" class="form-control" placeholder="Enter Issue" value=""></div>
               ...
               <div class="col-md-12"><label for="birthday">Select Appointment Date</label>
  				<input type="date" id="birthday" name="pdate"></div>
            </div>
        </div>
    </div>
</div>
